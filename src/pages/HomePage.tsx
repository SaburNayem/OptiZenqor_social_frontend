    ...
    <div className="space-y-6">
      ...
      <section className="space-y-4">
        {app.isLoading ? (
          ...
          <Card>
            <p className="text-lg font-semibold text-slate-950 dark:text-white">Your feed is live but quiet.</p>
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
              Follow people, publish a post, or wait for backend content to arrive.
            </p>
          </Card>
        ) : (
